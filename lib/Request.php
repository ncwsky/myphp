...
class Request
{
    ...
    public static $ipHeaders = ['HTTP_X_REAL_IP', 'HTTP_X_FORWARDED_FOR','HTTP_ALI_CDN_REAL_IP'];
     ...
     * @return $this
     */
    public function setPost(string $name, $val): Request
    {
        $_POST[$name] = $val;
        return $this;
    }
     ...
     * @return $this
     */
    public function setGet(string $name, $val): Request
    {
        $_GET[$name] = $val;
        return $this;
    }
